  ...
  return (
    <div className="min-h-screen bg-basic pt-24 pb-24 px-4">
      ...
      <div className="flex flex-col text-center">
        <h1 className="text-[#307532] text-3xl mt-14 font-semibold">
          Har du spørsmål eller ønsker du å leie?
        </h1>

        <Link
          href="/#kontakt"
          className="md:px-8 md:py-2.5 px-6 py-1.5 text-white justify-center font-semibold text-2xl transition-all duration-200 rounded-xl mt-8 hover:underline bg-[#307532] hover:bg-[#4db750] cursor-pointer flex items-center space-x-2"
        >
          <FaArrowRight />
          <p>Ta kontakt</p>
          <FaArrowLeft />
